...
- Write detailed `PLAN-ISSUE-{number}.md` file in `.agent-workforce/reports/`
...
- ✅ `.agent-workforce/reports/PLAN-ISSUE-{number}.md` - Implementation plan
- ✅ `.agent-workforce/reports/ARCHITECTURE-{feature}.md` - Architecture decisions
- ✅ `.agent-workforce/reports/RESEARCH-{topic}.md` - Research findings
- ✅ `.agent-workforce/reports/MIGRATION-{version}.md` - Migration guides
- ✅ Any `.md` documentation file in `.agent-workforce/` for planning purposes
...
# Use Write tool to create .agent-workforce/reports/PLAN-ISSUE-{number}.md
```
...
git add .agent-workforce/reports/PLAN-ISSUE-{number}.md
...
gh issue comment {number} --body "Implementation plan created: see .agent-workforce/reports/PLAN-ISSUE-{number}.md in branch feature/issue-{number}-{short-description}"
```
